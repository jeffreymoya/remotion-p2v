...
export enum EasingPreset {
  ...
  Slam = "slam",
  /** cubic-bezier(0.34, 1.56, 0.64, 1) — overshoot pop for chart marks */
  Spring = "spring",
  /** Sine in-out — slow Ken Burns pan/zoom drift */
...
const PRESETS: Record<EasingPreset, EasingFn> = {
  ...
  [EasingPreset.Spring]: Easing.bezier(0.34, 1.56, 0.64, 1),
  [EasingPreset.EaseInOutSine]: Easing.inOut(Easing.sin),
};
